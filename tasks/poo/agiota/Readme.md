...
![cover](../../.tko/cache/poo/base/agiota/cover.png)
...
<!-- links .cache/draft -->
- cpp
  - [shell.cpp](../../.tko/cache/poo/base/agiota/.cache/draft/cpp/shell.cpp)
- java
  - [Shell.java](../../.tko/cache/poo/base/agiota/.cache/draft/java/Shell.java)
- ts
  - [shell.ts](../../.tko/cache/poo/base/agiota/.cache/draft/ts/shell.ts)
<!-- links -->

## Guide

![diagrama](../../.tko/cache/poo/base/agiota/diagrama.png)

[![youtube icon](../../.tko/cache/poo/base/agiota/..//yousolver.png)](https://youtu.be/XBJrKDd5fYY?si=HkQInss4B1x3HEYF)
...
![_](../../.tko/cache/poo/base/agiota/ptolomeu.jpg)
